...
public class FacturaController extends AbstractMB implements Serializable {
    ...
    public void guardarFactura() {
        ...
        try {
            ...
            if (LoginController.getInstance().getUsuario().getRolId().getAlmaId().getAlmaFacturaAutonumerada()) {
                LoginController.getInstance().getUsuario().getRolId().getAlmaId().setAlmaNumFactura(LoginController.getInstance().getUsuario().getRolId().getAlmaId().getAlmaNumFactura() + 1);
            ...
            displayErrorMessageToUser("Ya existe una factura con ese número");
        }
